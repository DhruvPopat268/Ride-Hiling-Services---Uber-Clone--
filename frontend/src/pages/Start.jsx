...
const Start = () => {
  return (
    <>  
      <div>
        <div className=' h-screen  bg-cover bg-center bg-[url(https://media.istockphoto.com/id/526811099/vector/traffic-lights.jpg?s=2048x2048&w=is&k=20&c=TSpW3fge7mgaIPiSYqTyNf0OKcYwcvPFZe8d7WY9ElY=)] flex justify-between flex-col'>
